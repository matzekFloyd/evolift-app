...
export function CompactRowActions({
  ...
  const buttonClass =
    "inline-flex h-8 w-16 sm:w-20 items-center justify-center rounded-md border border-zinc-300 bg-zinc-50 px-2 py-1 text-xs text-zinc-800 hover:border-sky-300 hover:bg-zinc-100";
